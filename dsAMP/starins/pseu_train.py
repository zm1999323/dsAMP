...
train_pos = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/anti-pseudomonas/dataset/pseudomonas_aeruginosa_train80.h5'
train_neg = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/anti-pseudomonas/dataset/pseudo_neg_cdhit40_train80.h5'
...
for fold, (train_index, test_index) in enumerate(skf.split(train_dataset, train_dataset.get_targets())):
    ...
    net = Classifier3(num_classes=num_classes)
    # net_weights_path = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/anti-bacterial/3-1/best_model_fold_1.pth'
    ...
    optimizer = optim.Adam(net.parameters(), lr=0.000003,weight_decay=0.0010)
...
#
plt.tight_layout()
plt.savefig('average_antipsue.png')
