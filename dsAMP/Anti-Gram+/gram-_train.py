...
train_pos = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/anti-Gram-/dataset/anti_gram-_pos_cdhit90_train80.h5'
train_neg = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/anti-Gram-/dataset/anti_gram-_neg_cdhit90_train80.h5'
...
for fold, (train_index, test_index) in enumerate(skf.split(train_dataset, train_dataset.get_targets())):
    ...
    # net_weights_path = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/AMP/3-1/best_model_fold_6.pth'
    ...
    optimizer = optim.Adam(net.parameters(), lr=0.000004,weight_decay=0.0007)
...
#
plt.tight_layout()
plt.savefig('average_antiGram-.png')
