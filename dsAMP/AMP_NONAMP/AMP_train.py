...
from setnet2 import Classifier2
from torch.utils.data import DataLoader, random_split
import matplotlib.pyplot as plt
from sklearn.metrics import roc_curve, auc, precision_score, recall_score, f1_score,matthews_corrcoef,confusion_matrix
...
# test_pos = '/home/wuyou/project/pythonProject5/pythonProject1/data/pos.h5'
# test_neg = '/home/wuyou/project/pythonProject5/pythonProject1/data/neg.h5'
# train_pos = '/home/wuyou/project/pythonProject5/pythonProject1/data/pos_cdhit.h5'
# train_neg = '/home/wuyou/project/pythonProject5/pythonProject1/data/neg_cdhit.h5'
# test_pos = '/home/wuyou/project/pythonProject5/pythonProject1/data/AMP.h5'
# test_neg = '/home/wuyou/project/pythonProject5/pythonProject1/data/nonAMP.h5'
train_pos = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/data/AMPs_cidHit90_train80.h5'
train_neg = '/home/wuyou/project/pythonProject5/pythonProject/pythonProject1/data/nonAMPs_cidHit40_train80.h5'
...
for fold, (train_index, test_index) in enumerate(skf.split(train_dataset, train_dataset.get_targets())):
    ...
    net = Classifier2(num_classes=num_classes)

    net.to(device)
    loss_function = nn.CrossEntropyLoss()
    optimizer = optim.Adam(net.parameters(), lr=0.000008,weight_decay=0.0001)
    ...
    # 保存指标
    # with open(f"metrics_fold_{fold + 1}.csv", mode="w", newline="") as csvfile:
    #     writer = csv.writer(csvfile)
    #     writer.writerow(["Epoch", "Train Loss", "Train Accuracy", "Val Accuracy", "Precision", "Recall", "F1-score"])
    #     for epoch, train_loss, train_accuracy, val_accuracy, precision, recall, f1_score in zip(range(1, epochs + 1),
    #                                                                                             train_losses,
    #                                                                                             train_accuracies,
    #                                                                                             val_accuracies,
    #                                                                                             precisions, recalls,
    #                                                                                             f1_scores):
    #         writer.writerow([epoch, train_loss, train_accuracy, val_accuracy, precision, recall, f1_score])
...
#
plt.tight_layout()
plt.savefig('average_AMP_2.png')

# plt.subplot(1, 3, 2)
# for train_accuracies, val_accuracies in zip(all_train_accuracies, all_val_accuracies):
...
#
# plt.subplot(1, 3, 3)
# for precisions, recalls, f1_scores in zip(all_precisions, all_recalls, all_f1_scores):
#     plt.plot(range(1, epochs + 1), precisions, label='Precision')
#     plt.plot(range(1, epochs + 1), recalls, label='Recall')
#     plt.plot(range(1, epochs + 1), f1_scores, label='F1-score')
# plt.xlabel('Epochs')
